                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php foreach($data_info as $data_info)
                                    {
                                ?>
                                <form action="<?php echo base_url('c_admin/tambah_data_info') ?>?username=<?php echo $data_info['username']?>" method="post">
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input id="inputEmail" type="text" placeholder="<?php echo $data_info['username']?>" class="form-control" name ="username"> 
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail">Password</label>
                                        <input id="inputEmail" type="password" placeholder="<?php echo $data_info['password']?>" class="form-control" name="password">                                                
                                    </div> -->
                                <?php
                                    }
                                ?>
