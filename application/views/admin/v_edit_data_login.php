                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url('c_admin/edit_data_login') ?>?id_datalogin=<?php echo $data_login['id_datalogin']?>" method="post">
                                    ...
                                    <!-- <div class="form-group">
                                        <input id="inputText3" type="text" class="form-control" value="<?php echo $data_login['id_login']?>" name="id_login" hidden>
                                    </div> -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputEmail" type="number" value="<?php echo $data_login['level']?>" class="form-control" name="level">-->
                                <?php
                                    }
                                ?>
                                <br>
